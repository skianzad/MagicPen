...
public class HVirtualCoupling {
    ...
    protected float vc_stiffness = 250000.0F;//10000F;// 250000.0F; //numbers of the left: smaller avatar. on the right: bigger avatar. Change size in .pde file.
    protected float vc_damping = 700.0F;//60F;//700.0F;
    protected float vc_free_mass = 0.0025F;//0.01F;//0.00525F;
    protected float vc_contact_mass =  0.01F;//1.5F;// 0.10F;
    ...
    public HVirtualCoupling(float size) {        
        ...
        this.h_avatar.setRotatable(true);
