...
centerTime = importdata('centerTime.txt');
centerX = importdata('centerX.txt');
centerY = importdata('centerY.txt');
...
hold on
plot(centerX.*40,centerY.*40, '+');
plot(worldWidth/2*40, worldHeight/2*40, 'o');
%xlim([-1 17.5])
%ylim([-19 0])
