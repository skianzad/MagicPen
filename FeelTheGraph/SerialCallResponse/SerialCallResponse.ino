...
if (Serial.available()){
  memset(string,0,6);
  Serial.readBytesUntil(ending,string,nm_byte);
    if(string[0]=='a'){
       string[0]='X';
       byteRead=string[1]+string[2]+string[3];
//       byteRead.parseInt(sp);
      Serial.println(string);  
    }else if(string[0]=='b'){
      string[0]='K';
      string[1]='c';
      string[2]='q';
      byteRead=string[1]+string[2]+string[3]+string[4]+string[5]+string[6];
      sp=byteRead.toInt();
      Serial.println(string); 
    }else if(string[0]=='c'){
      string[0]='W';
  ...
  //  Serial.println(string[0],DEC);
     // Serial.write(string,nm_byte);
    }
}
